...
DB_URI = environ.get("DB_URI", "mongodb+srv://filestorebot:filestorebot@cluster0.kqfi0qs.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
AUTO_DELETE = int(environ.get("AUTO_DELETE", "02")) # Time in Minutes
...
VERIFY_TUTORIAL = environ.get("VERIFY_TUTORIAL", "https://t.me/tenxbackupchannel") # how to open link 
